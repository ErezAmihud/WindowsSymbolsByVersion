#!/bin/bash
#Generated on 2024-10-19 22:13:08 GMT
...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=c598cdd6-8d6a-4fa1-8161-8e96e362b127&pack=en-us&edition=core;coren;professional;professionaln&aria2=2"
if [ $? != 0 ]; then
