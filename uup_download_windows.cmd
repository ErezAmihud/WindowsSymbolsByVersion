@echo off
:: Generated on 2024-10-20 17:37:53 GMT
...
:START_PROCESS
title 19044.4529_amd64_en-us_multi_a0f51b86 download
...
REM powershell -NoProfile -ExecutionPolicy Unrestricted .\files\get_aria2.ps1 || (pause & exit /b 1)
echo.
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=a0f51b86-2ddf-40a9-8df4-870619b2ff1d&pack=en-us&edition=core;coren;professional;professionaln&aria2=2"
